...
# PDF Processing
if txtattachment is not None and txtattachment.type == 'application/pdf':
    pdf_reader = PyPDF2.PdfFileReader(txtattachment)
    num_pages = pdf_reader.numPages
    st.write(f"The PDF file contains {num_pages} pages.")

    page_num = st.number_input("Enter the page number you want to extract:", min_value=1, max_value=num_pages)
